...
export class MoviesController {
  ...
  @Get("like/:id")
  @GetLikesDecorator
  getLikes(@Param("id", IsValidObjectIdPipe) id: string): Promise<Document[]> {
    return this.moviesService.findLikes(id);
  }
  ...
  async unlikeMovie(
    ...
    const success = await this.moviesService.unlike(id, user);
